# AGENTS.md — PT Indah Tambang Raya Semesta
...
The `agentic-learning` skill is installed at `C:/Users/indra/.config/opencode/learnship/skills/agentic-learning/SKILL.md`. When a workflow checkpoint or the user asks you to use the agentic-learning skill:

1. Read `C:/Users/indra/.config/opencode/learnship/skills/agentic-learning/SKILL.md`
...
The `impeccable` skill is installed at `C:/Users/indra/.config/opencode/learnship/skills/impeccable/SKILL.md`. When a workflow checkpoint or the user asks you to use the impeccable skill:

1. Read `C:/Users/indra/.config/opencode/learnship/skills/impeccable/SKILL.md`
...
Read it before proposing approaches that may conflict.
